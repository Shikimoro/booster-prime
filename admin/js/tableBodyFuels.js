...
// ----------------------------------------------------------------------------------------------------------------------------------------------
 ...
 function tableContent(){
      let tableBodyFuels = document.getElementById('tableBodyFuels');

     fetch('../admin/function/getFuels.php')
      ...
      for(let i = 0; i < data.length; i++) {
        ...
        let tableFuelsCost = document.createElement('td');
        tableFuelsCost.textContent = opt.cost;
  
        let tableFuelsMinAmount = document.createElement('td');
        tableFuelsMinAmount.textContent = opt.min_amount;
  ...
  // ------------------------КНОПКА В ТАБЛИЦЕ--------------------------------------
   ...
   // ------------------------КНОПКА В ТАБЛИЦЕ--------------------------------------
        ...
        row.appendChild(tableFuelsCost);
        row.appendChild(tableFuelsMinAmount);
        row.appendChild(idTableElement);
  // ------------------------КНОПКА В ТАБЛИЦЕ--------------------------------------
        row.appendChild(tableButton);
  // ------------------------КНОПКА В ТАБЛИЦЕ--------------------------------------
        tableBodyFuels.appendChild(row);
