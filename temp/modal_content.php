<div class="modal fade" id="ModalAddendum" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Подтверждение заказа</h1>
      ...
      <div class="modal-body">
        ...
        <br>
        <span id="modalOilType"></span>
        <br>
        <span id="modalSum"></span>
        <br>
      ...
      <div class="modal-footer">
        ...
        <button id="addOrder" type="button" class="btn btn-primary" onclick="confirmOrder()">Да</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="ModalAddendumOnlinePayment" tabindex="-1" data-bs-backdrop="static"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment" method="post"
          accept-charset="utf-8">

          <div class="ym-products">
            <div class="ym-block-title ym-products-title">Товар</div>
            <div class="ym-product">
              <div class="ym-product-line">
                <span class="ym-product-description"><span id="oilAmountOnline" class="ym-product-count">10×</span><span
                    id="oilTypeOnline"></span></span>
                <span id="sumForPay" class="ym-product-price" data-price="" data-id="650"
                  data-count="">1000,00&nbsp;₽</span>
              </div>
              <input disabled="" type="hidden" name="text" value="kjk"><input disabled="" type="hidden" name="price"
                value="7">
              <input disabled="" type="hidden" name="quantity" value="5"><input disabled="" type="hidden"
                name="paymentSubjectType" value="commodity">
              <input disabled="" type="hidden" name="paymentMethodType" value="full_prepayment"><input disabled=""
                type="hidden" name="tax" value="1">
            </div>
          </div>
          ...
          <div class="ym-customer-info">
            ...
            <input id="phoneOnline" name="cps_phone" class="ym-input " placeholder="Телефон" type="text"
              value="888888888888" disabled>
            <input id="nameOnline" name="custName" class="ym-input" placeholder="ФИО" type="text" value="" disabled>
            <input id="addressOnline" name="custAddr" class="ym-input" placeholder="Адрес" type="text" value=""
              disabled>
          </div>
          <div class="ym-hidden-inputs">
            <input name="shopSuccessURL" type="hidden" value="localhost:3000/page?succesFunction=true">
            <input name="shopFailURL" type="hidden" value="localhost:3000/page?errorFunction=true">
          </div>

          <input name="customerNumber" type="hidden" value="Оплата заказа Booster Prime">
          <div class="ym-payment-btn-block ym-before-line ym-align-space-between">
            <div class="ym-input-icon-rub ym-display-none">
              <input id="sumForPayOnline" name="sum" placeholder="0.00" class="ym-input ym-sum-input ym-required-input"
                type="number" step="any" value="">
            </div>
            <button data-text="Оплатить " class="ym-btn-pay ym-result-price" onclick="confirmOrder()"><span
                class="ym-text-crop">Оплатить </span>
              <span id="sumOnline" class="ym-price-output">100,00&nbsp;₽</span></button>
            ...
            <lineargradient id="paint1_linear" x1="12.8472" y1="9.35889" x2="12.8472" y2="55.2393"
          ...
          <input name="shopId" type="hidden" value="301238">
        </form>
        <script src="js/yookassa_form.js"></script>
        <br>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="ModalAddendumSuccesful" tabindex="-1" data-bs-backdrop="static"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered ">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Успешно</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"></button>
      </div>
      <div class="modal-body text-center">

        <h3>Номер вашего заказа: <span id="orderNumberForAddendum"></span></h3>

        <img class="img-fluid" src="img/succec.png" style="max-width: 60% !important;">
        <br>
        <span>Доставка будет в течении 15 - 20 минут</span>
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="ModalAddendumError" tabindex="-1" data-bs-backdrop="static"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body" style="display: flex; justify-content: center;">
        <img src="img/error.png" style="width: 50% !important; height: 50% !important;">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">OK</button>
      </div>
...
<div class="modal fade" id="ModalNotDeliveryTime" tabindex="-1" data-bs-backdrop="static"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">На указанное время заказы не принимаются</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"></button>
      </div>
      <div class="modal-body">
        <span>График работы</span>
        <br>
        <span>Пн - Пт с 8:00 до 19:45 </span>
        <br>
        <span>Cб с 8:00 до 17:45 </span>
        <br>
...
<div class="modal fade" id="ModalCheckOrderStatus" tabindex="-1" data-bs-backdrop="static"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Статус заказа</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"></button>
      </div>
      <div class="modal-body">
        ...
        <br>
        <span id="modalOrderAddress"></span>
        <br>
        <span id="modalOrderSum"></span>
        <br>
        <span id="modalDeliveryTime"></span>
        <br>
        <span id="modalOrderStatusPayment"></span>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">OK</button>
      </div>
...
<div class="modal fade" id="ModalCheckOrderStatusError" tabindex="-1" data-bs-backdrop="static"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
